...
model_path = r"E:\Kuliah Semester 5\PMDPM\DeepLearning\Introduction to Deep Learning (Praktek)\best_model_tf.h5"
...
try:
    if os.path.exists(model_path):
        ...
        st.title("Fashion MNIST Image Classifier 1840")  
